...
export async function POST(req) {
    ...
    try {
        ...
        const query = 'INSERT INTO libStats (floorID, updatedBy, busyScale, createdAt) VALUES (?, ?, ?, ?)';
        await db.execute(query, [data.floor, data.updatedBy | null, data.busyScale, data.timeStamp]);
